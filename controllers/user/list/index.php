...
echo "<div class=\"col\">";
    if($currentPage > 1 && $totalPage > 0) {
        ...
        echo "<a  class=\"btn btn-secondary text-decoration-none\" href=\"javascript:void(0)\">Prev</a>";
    }
    for($i = 1; $i <= $totalPage; $i++) {
        echo "</div>";
        echo "<div class=\"col\">";
        echo '<a class="rounded-circle btn btn-dark text-decoration-none '. ($currentPage == $i? 'bg-light text-dark"': '"').' href="index.php?page='. $i .'">' . $i . '</a>';
        echo "</div>";
        echo "<div class=\"col\">";
    }
    if($currentPage < $totalPage && $totalPage > 1) {
        ...
        echo "<a  class=\"btn btn-secondary text-decoration-none\" href=\"javascript:void(0)\">Next</a>";
    }
